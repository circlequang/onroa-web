...
function createHomepageGoogleMap(_latitude,_longitude,json){
    ...
    function gMap(){
		...
		if((vconfig != null) || (vconfig != undefined)) {
			zmlat01 = vconfig.zmlat01;
			zmlat02 = vconfig.zmlat02;
			zmlng01 = vconfig.zmlng01;
			zmlng02 = vconfig.zmlng02;
			zmzoom = vconfig.zmzoom;
		...
		mapCenter = new google.maps.LatLng(_latitude,_longitude);
			...
			map.addListener('center_changed', function(event) {
				...
				if(((lat >= _lat - zmlat01) && (lat <= _lat + zmlat02)) && 
					((lng >= _lng - zmlng01) && (lng <= _lng + zmlng02)))
					return;
